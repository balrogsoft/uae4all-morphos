...
MORE_CFLAGS =  -O3 -Isrc/ -Isrc/include/ -Isrc/menu -Isrc/vkbd -ffast-math -fomit-frame-pointer  -Wno-unused -Wno-format -DUSE_SDL -DGCCCONSTFUNC="__attribute__((const))" -DUSE_UNDERSCORE -fno-exceptions -DUNALIGNED_PROFITABLE -DREGPARAM="__attribute__((regparm(3)))" -DOPTIMIZED_FLAGS -D__inline__=__inline__ -DSHM_SUPPORT_LINKS=0 -DOS_WITHOUT_MEMORY_MANAGEMENT -DVKBD_ALWAYS


MORE_CFLAGS+= -DROM_PATH_PREFIX=\"./\" -DDATA_PREFIX=\"data/\" -DSAVE_PREFIX=\"./\"

MORE_CFLAGS+= -DMORPHOS -DFAME_BIG_ENDIAN
